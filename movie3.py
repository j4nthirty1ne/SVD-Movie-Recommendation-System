...
def find_closest_movies(df, search_query):
    ...
    if not related_movies.empty:
        print("\n🎞️ Related Movies (Same Genre or Director, Max 10):")
        print(tabulate(related_movies[["movie", "director", "runtime", "release", "genre"]], headers="keys", tablefmt="pretty", showindex=False))
